...
| {doc}`transformer` | 自注意力、多头、FFN、O(n²)问题 | 与 {doc}`../cnn-expedition/image-net-era/index` 的两种注意力对比 |
...
- **CNN注意力与自注意力的区别**：{doc}`../cnn-expedition/image-net-era/introduction` 中通道/空间注意力的基本概念
```
